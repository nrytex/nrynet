...
var connectionErrorRules = []struct {
	...
	{"remote agent connections require wss", "公网服务器必须使用 wss:// 加密连接，请修改控制服务器地址。"},
	{"insecure_skip_verify", "公网连接不能跳过 TLS 证书校验，请关闭该选项后重试。"},
	...
	{"unknown authority", "无法验证服务器证书，请配置正确的私有 CA 文件或使用受信任证书。"},
